...
import { fetchAllProductsAsync, fetchBrandsAsync, fetchCategoriesAsync, fetchProductsByFiltersAsync, selectAllProducts, selectBrands, selectCategories, selectTotalItems } from '../../productList/productSlice';
...
export default function AdminProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      ...
      // Check if the array exists before trying to find and remove the value
      if (newfilter[section.id]) {
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-9">
            ...
            <button
                ...
                type="submit" 
                className=" rounded-md bg-green-700 px-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700"
              >
              + New Product
              </button>
              </Link>
  ...
  return ( 
      <div className="lg:col-span-3 mt-7">
                ...
                <div className="bg-white mt-8">
                  <div className="mx-auto -mt-20 max-w-2xl px-4 py-5 sm:px-6 sm:py-15 lg:max-w-7xl lg:px-8">
                  ...
                  {products.map((product) => (<div>
                    ...
                    <button
                type="submit"
                className="w-30 mt-2 ml-16 p-2 justify-center rounded-md bg-indigo-600 px-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Edit Product
              </button>
                    </div>
